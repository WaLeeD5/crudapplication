...
$query= "INSERT INTO users (first_name,last_name,email,phone_no,password) VALUES
 ('$firstname','$lastname','$email','$phone','$password')";


$ins= mysqli_query($con,$query) or die('error in insert values');
if($ins){
...
<body>
    ...
    <section class="section wb">
                ...
                <div class="row">
                    <div class="col-lg-10 offset-lg-1">
                        <div class="page-wrapper">
                            ...
                            <div><p><center><font size="30" color="black"><strong>Registration Form</strong></font></center></p>
                            </div> 
            ...
            <input type="password" class="form-control" placeholder="Enter Password"  name="password">
                                        ...
                                        <button type="submit" class="btn btn-primary" name="signup">Submit <i class="fa fa-envelope-open-o"></i></button>
                                    </form>
                                </div>
                            </div>
